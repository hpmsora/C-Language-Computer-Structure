...
void f3d_nunchuk_init(void) {
  ...
  f3d_i2c1_write(NUNCHUK_ADDRESS,0xf0,&buf_1); 
  f3d_i2c1_write(NUNCHUK_ADDRESS,0xfb,&buf2_1);
  f3d_i2c2_write(NUNCHUK_ADDRESS,0xf0,&buf_2); 
  f3d_i2c2_write(NUNCHUK_ADDRESS,0xfb,&buf2_2);
}
...
void f3d_nunchuk_read_2(nunchuk_t *n) {
  uint8_t data[6] = {0,0,0,0,0,0};
  int i;
  unsigned short tmp;
